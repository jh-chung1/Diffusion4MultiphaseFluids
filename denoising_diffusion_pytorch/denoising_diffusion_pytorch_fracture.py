...
class GaussianDiffusion_f(nn.Module):
    def __init__(
        self,
        model,
        *,
            ...
            while self.step < self.train_num_steps:
                ...
                if accelerator.is_main_process:
                    ...
                    if self.step != 0 and divisible_by(self.step, self.save_and_sample_every):
                        ...
                        sample_img = test_batch[:min_samples]*all_images[:min_samples]
                        ...
                        # 2D fracture
                        combined_start_sample_images = torch.stack([test_batch[:min_samples],all_images[:min_samples]], dim=1).view(-1, *test_batch.shape[1:])
